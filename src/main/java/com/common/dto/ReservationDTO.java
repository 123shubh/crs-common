...
public class ReservationDTO {
	...
	public ReservationDTO(String reservationId, String hotelId, String hotelName, int guestId,
	...
	public String toString() {
		return "ReservationDTO [reservationId=" + reservationId + ", hotelId=" + hotelId + ", hotelName=" + hotelName
